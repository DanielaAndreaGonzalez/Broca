<!-- En la carpeta views deben crear una subcarpeta layouts y alli agregar este archivo que se debe denominar layout.blade.php -->
...
<head>
    ...
    <title>@yield('title','Aplicación de Estudiantes')</title>
    ...
    <!-- Estas líneas son de los data table que utilizaremos -->
